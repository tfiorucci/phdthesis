...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.35\textwidth]{subfiles/imgs/altarica-dysfunctional-model.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{subfiles/imgs/wrongly_identified_for_paper.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.2]{subfiles/imgs/chrono_write.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.2]{subfiles/imgs/I2C_AHB.png}
    \caption{I2C to AHB System Model}
    \label{fig:i2cahb}
\end{figure}
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.2]{subfiles/imgs/I2C_module.png}
    \caption{I2C Block Model}
    \label{fig:i2caps}
\end{figure}
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.2]{subfiles/imgs/AHB_module.png}
